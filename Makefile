...
all:
	...
	$(_V)$(TASS) -Dtruncated=true --m65c02 --nostart -Wall $(_TASSQ) --case-sensitive --line-numbers --verbose-list -o "build/dfs245.truncated.rom" -Lbuild/dfs245.truncated.lst dfs245.s65

	$(_V)$(PYTHON) "bin/romdiffs.py" -a "$(BUILD)" -b "orig" dfs245.rom dfs245.truncated.rom
